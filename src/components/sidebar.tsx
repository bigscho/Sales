...
const navItems: NavItem[] = [
  ...
  { href: "/scoreboard", label: "Scoreboard", icon: "🏆", roles: ["setter", "show_rate_rep", "admin"] },
  ...
  { href: "https://www.youtube.com/watch?v=zIG39WlSCsM", label: "Motivation", icon: "🔥", roles: ["setter", "show_rate_rep", "admin"] },
